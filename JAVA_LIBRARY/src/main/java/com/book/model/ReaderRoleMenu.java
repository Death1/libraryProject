 ...
 */
@Entity
@Table(name = "READERROLEMENU", schema = "TEST")
public class ReaderRoleMenu implements java.io.Serializable
{
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "idGeneration")
	@SequenceGenerator(name = "idGeneration", sequenceName = "READERROLEMENU_SEQUENCE", allocationSize = 1)
	private Integer id;
